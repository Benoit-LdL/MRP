...
AccelStepper stepper1(AccelStepper::DRIVER, 46,48); // Defaults to AccelStepper::FULL4WIRE (4 pins) on 2, 3, 4, 5
AccelStepper stepper2(AccelStepper::DRIVER, 54,55);
